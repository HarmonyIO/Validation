...
class Version4Test extends TestCase
{
    ...
    {
        $this->assertInstanceOf(Rule::class, new Version4());
    }

    public function testValidateReturnsFalseWhenPassingAnInteger(): void
    {
        $this->assertFalse((new Version4())->validate(1));
    }

    public function testValidateReturnsFalseWhenPassingAFloat(): void
    {
        $this->assertFalse((new Version4())->validate(1.1));
    }

    public function testValidateReturnsFalseWhenPassingABoolean(): void
    {
        $this->assertFalse((new Version4())->validate(true));
    }

    public function testValidateReturnsFalseWhenPassingAnArray(): void
    {
        $this->assertFalse((new Version4())->validate([]));
    }

    public function testValidateReturnsFalseWhenPassingAnObject(): void
    {
        $this->assertFalse((new Version4())->validate(new \DateTimeImmutable()));
    }

    public function testValidateReturnsFalseWhenPassingNull(): void
    {
        $this->assertFalse((new Version4())->validate(null));
    }
    ...
    public function testValidateReturnsFalseWhenPassingAResource(): void
    {
        ...
        $this->assertFalse((new Version4())->validate($resource));
    ...
    {
        $this->assertFalse((new Version4())->validate(static function (): void {
        }));
    }
    ...
    {
        $this->assertTrue((new Version4())->validate($uuid));
    }
    ...
    {
        $this->assertFalse((new Version4())->validate($uuid));
    }
