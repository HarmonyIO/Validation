...
class Version3Test extends TestCase
{
    ...
    {
        $this->assertInstanceOf(Rule::class, new Version3());
    }

    public function testValidateReturnsFalseWhenPassingAnInteger(): void
    {
        $this->assertFalse((new Version3())->validate(1));
    }

    public function testValidateReturnsFalseWhenPassingAFloat(): void
    {
        $this->assertFalse((new Version3())->validate(1.1));
    }

    public function testValidateReturnsFalseWhenPassingABoolean(): void
    {
        $this->assertFalse((new Version3())->validate(true));
    }

    public function testValidateReturnsFalseWhenPassingAnArray(): void
    {
        $this->assertFalse((new Version3())->validate([]));
    }

    public function testValidateReturnsFalseWhenPassingAnObject(): void
    {
        $this->assertFalse((new Version3())->validate(new \DateTimeImmutable()));
    }

    public function testValidateReturnsFalseWhenPassingNull(): void
    {
        $this->assertFalse((new Version3())->validate(null));
    }
    ...
    public function testValidateReturnsFalseWhenPassingAResource(): void
    {
        ...
        $this->assertFalse((new Version3())->validate($resource));
    ...
    {
        $this->assertFalse((new Version3())->validate(static function (): void {
        }));
    }
     ...
     */
    public function testValidateReturnsTrueWhenPassingAValidV3UuidString(string $uuid): void
    {
        $this->assertTrue((new Version3())->validate($uuid));
    }

    /**
     * @dataProvider provideInvalidUuids
     */
    public function testValidateReturnsFalseWhenPassingAnInvalidV3UuidString(string $uuid): void
    {
        $this->assertFalse((new Version3())->validate($uuid));
    }
